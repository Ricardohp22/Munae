...
CREATE TABLE IF NOT EXISTS obras (
  ...
  medidas_soporte_profundidad INTEGER,
  medidas_imagen_ancho INTEGER,
  medidas_imagen_largo INTEGER,
  medidas_imagen_profundidad INTEGER,
  medidas_marco_ancho INTEGER,
  medidas_marco_largo INTEGER,
  medidas_marco_profundidad INTEGER,
  ...
  estado_conservacion VARCHAR(750),
